...
// 　　　　},
        ...
        selYear:function(){
            ...
            //请求数据
            this.selTime('/qualityIssue/selectYear');
        },
        //选择今天
        selDay:function(){
            this.isActive1=true;
            ...
            //请求数据
            this.selTime('/qualityIssue/selectToday');
        },
        //选择本周
        selWeek:function(){
            this.isActive2=true;
            ...
            this.isActive4=false;
            //请求数据
            this.selTime('/qualityIssue/selectWeek');
        },
        selMonth:function(){
            this.isActive3=true;
            this.isActive1=false;
            ...
            this.isActive4=false;
            //请求数据
            this.selTime('/qualityIssue/selectMonth');
        },
        ...
        urlHtml:function(){
            window.location.href=zyfUrl+"/qualityProblem.html";
        }
　　},
     mounted: function() {
        var _this=this;
        _this.selYear();
        //请求数据调用
        this.$http.post(zyfUrl + '/qualityIssue/getQualityOperatorLog', {
            userId:userId,
            projectId:projectId,
            jwt:jwt,
            //projectId:"1",
...
<!--<div class="root">-->
    <main id="root" class="app-main">
        <div class="wrap">
            <section class="app-content" id="quality-overview">
                <!-- search results -->
                <!--相应内容-->
                <div class="row">
                    <!--chart left-->
                                                ...
                                                <tr>
                                                    <td class="mail-left">
                                                        <div class="avatar avatar-sm avatar-circle">
							                                ...
							                                <img class="img-responsive" v-else :src="zyfUrl+'/acc/getPicBy/'+item.headPortrait+'?userId='+userId+'&projectId='+projectId+'&jwt='+jwt" alt="avatar"/>
